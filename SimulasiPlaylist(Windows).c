...
*           
*   @title      PROGRAM SIMULASI PLAYLIST (VERSI WINDOWS)
*
...
void panduanProgram() {
    ...
    printf("Solusi lain adalah dengan membuka file .exe hasil build code ini dan double click di Windows Explorer atau dengan PowerShell.\n\n");
    printf("Program ini hanya bisa berjalan di Windows. Untuk versi Linux, gunakan program versi Linux yang telah disediakan.\n\n");
    Spasi();
    Jeda();
    panduanMenu();
}
...
void menuUtama(ElemenMusik **L) {
    ...
    Sleep(2000); //agar jika dibuka langsung dari file .exe, tulisan terima kasih dapat dibaca
}
